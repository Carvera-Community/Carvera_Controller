...
class ToolTipButton(Button):
    ...
    def _update_image_size(self, instance, value):
        if self.tooltip_image_size:
            ...
            instance.size = instance.texture_size[0]/2, instance.texture_size[0]/2

    def _update_tooltip_size(self):
        self._tooltip.size = self._tooltip.minimum_size
    ...
    def on_mouse_pos(self, *args):
        ...
        tooltip_height = tooltip_label.texture_size[1] + tooltip_image.height
